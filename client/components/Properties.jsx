		...
		<>
			...
			<ul>
				<section className="articles">
					...
					<div className="advert-banner-left"><img src="https://picsum.photos/800/600/?random" alt="Description" style={{"height" : "100%"}}/></div>
					<div className="advert-banner-right"><img src="https://picsum.photos/800/600/?random" alt="Description" style={{"height" : "100%"}}/></div>
				</section>
